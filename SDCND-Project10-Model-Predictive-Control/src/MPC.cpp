...
// These were choosen based on the udacity Q&A video.
size_t N = 10;
double dt = 0.1;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // The part of the cost based on the reference state. from quiz
    ...
    // Minimize the use of the actuators.
    ...
    // Minimize the value gap between actions
